...
Transplanted analog of NARANG RIDER feat/069. Synthetic official snapshots only;
no live provider calls, web search, or production learning.
"""
...
class CompetencyReport:
    ...
    def as_ci_artifact(self) -> dict[str, Any]:
        return {"schema": "apf.arkaon.map-competency.v1", **self.__dict__}
