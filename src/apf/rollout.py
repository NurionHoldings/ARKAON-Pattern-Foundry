"""Staged ARKAON rollout with independent review, fallback, and kill switch."""
...
from .branch_registry import BranchRegistry, BranchStatus
...
class ArkaonRolloutController:
    ...
    def promote_regional(
        ...
        *,
        ...
        deployments = [
            self.get_deployment(release_id, branch_id) for branch_id in sorted(required)
        ]
        if any(
